  ...
  _createClass(OKAny, [{
    ...
    value: async function validateAsync(input) {
      ...
      var testResults = await Promise.all(this.tests.map(async function (_ref3) {
        ...
        var res = await testFn(value, context);
...
var OKBoolean = function (_OKAny) {
  ...
  function OKBoolean(msg, transform) {
    var _this;
...
var OKNumber = function (_OKAny) {
  ...
  function OKNumber(msg, transform) {
    var _this;
  ...
  _createClass(OKNumber, [{
    ...
    key: "lessThan",
    value: function lessThan(max, msg) {
      this.addTest(function (v) {
        return v < max;
      }, msg || "Must be less than ".concat(max));
      return this;
    }
  }, {
    key: "moreThan",
    value: function moreThan(min, msg) {
      this.addTest(function (v) {
        return v > min;
      }, msg || "Must be greater than ".concat(min));
      return this;
    }
  }, {
    key: "positive",
...
var ok = {
  ...
  boolean: function boolean(msg, transform) {
    return new _boolean.default(msg, transform);
  },
  number: function number(msg, transform) {
    return new _number.default(msg, transform);
  },
  object: function object(shape, msg) {
    return new _object.default(shape, msg);
  },
  string: function string(msg, transform) {
    return new _string.default(msg, transform);
  }
};
var _default = ok;
exports.default = _default;
...
var OKString = function (_OKAny) {
  ...
  function OKString(msg, transform) {
    var _this;
